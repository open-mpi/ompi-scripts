...
data "amazon-ami" "autogenerated_5" {
  filters = {
    architecture        = "arm64"
...
data "amazon-ami" "autogenerated_6" {
  filters = {
    architecture        = "x86_64"
    name                = "RHEL-8.*-0-Hourly2-GP2"
    root-device-type    = "ebs"
...
data "amazon-ami" "autogenerated_7" {
  filters = {
    architecture        = "x86_64"
...
data "amazon-ami" "autogenerated_8" {
  filters = {
    architecture        = "x86_64"
...
data "amazon-ami" "autogenerated_9" {
  filters = {
    architecture        = "arm64"
...
data "amazon-ami" "autogenerated_10" {
  filters = {
    architecture        = "x86_64"
...
data "amazon-ami" "autogenerated_11" {
  filters = {
    architecture        = "arm64"
...
data "amazon-ami" "autogenerated_12" {
  filters = {
    architecture        = "x86_64"
...
data "amazon-ami" "autogenerated_13" {
  filters = {
    architecture        = "arm64"
...
data "amazon-ami" "autogenerated_14" {
  filters = {
    architecture        = "x86_64"
...
source "amazon-ebs" "FreeBSD13-x86" {
  ami_block_device_mappings {
    delete_on_termination = true
    device_name           = "/dev/sda1"
    volume_size           = 16
  }
  ami_name                    = "Jenkins FreeBSD 13 x86_64 ${var.build_date}"
  associate_public_ip_address = true
  ena_support                 = true
  iam_instance_profile        = "${var.iam_role}"
  instance_type               = "t3.large"
...
source "amazon-ebs" "RHEL7-x86" {
  ami_block_device_mappings {
    delete_on_termination = true
    device_name           = "/dev/sda1"
    volume_size           = 16
  }
  ami_name                    = "Jenkins RHEL 7 x86_64 ${var.build_date}"
  associate_public_ip_address = true
  ena_support                 = true
  iam_instance_profile        = "${var.iam_role}"
  instance_type               = "t3.large"
...
source "amazon-ebs" "RHEL8-arm64" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_5.id}"
  ssh_pty      = true
  ssh_username = "ec2-user"
}
...
source "amazon-ebs" "RHEL8-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_6.id}"
  ssh_pty      = true
  ssh_username = "ec2-user"
}
...
source "amazon-ebs" "SLES15-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_7.id}"
  ssh_pty      = true
  ssh_username = "ec2-user"
}
...
source "amazon-ebs" "Ubuntu1804-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_8.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2004-arm64" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_9.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2004-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_10.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2204-arm64" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_11.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2204-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_12.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2404-arm64" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_13.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}
...
source "amazon-ebs" "Ubuntu2404-x86" {
  ...
  region       = "us-west-2"
  source_ami   = "${data.amazon-ami.autogenerated_14.id}"
  ssh_pty      = true
  ssh_username = "ubuntu"
}

build {
  sources = ["source.amazon-ebs.AmazonLinux2-arm64", "source.amazon-ebs.AmazonLinux2-x86", "source.amazon-ebs.FreeBSD13-x86", "source.amazon-ebs.RHEL7-x86", "source.amazon-ebs.RHEL8-arm64", "source.amazon-ebs.RHEL8-x86", "source.amazon-ebs.SLES15-x86", "source.amazon-ebs.Ubuntu1804-x86", "source.amazon-ebs.Ubuntu2004-arm64", "source.amazon-ebs.Ubuntu2004-x86", "source.amazon-ebs.Ubuntu2204-arm64", "source.amazon-ebs.Ubuntu2204-x86", "source.amazon-ebs.Ubuntu2404-arm64", "source.amazon-ebs.Ubuntu2404-x86"]
